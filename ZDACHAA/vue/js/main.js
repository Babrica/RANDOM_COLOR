...
Vue.component('column1', {  //создание, удаление, редактирование карточки, время последнего редактирования
    ...
    <div class="column">
        ...
        <div  class="card" v-bind:style="{backgroundColor:card.coloR}"  v-for="card in column1">
            <ul>
                ...
                <button @click="randomColor(card)">Случайный цвет</button>
    ...
    methods: {
        ...
        randomColor(card){
            card.coloR = '#' + Math.floor(Math.random()*16777215).toString(16);
        }
    },
})
...
Vue.component('column2', {  //редактирование, время последнего редактирования, перемещение в третий столб
    ...
    <div class="column">
        <h3>Задачи в работе</h3>
         <div class="card" v-bind:style="{backgroundColor:card.coloR}"   v-for="card in column2">
            <ul>
...
Vue.component('column3', {  //редактирование, время последнего редактирования
    ...
    <div class="column">
        <h3>Тестирование</h3>
        <div class="card" v-bind:style="{backgroundColor:card.coloR}" v-for="card in column3">
            <ul>
...
Vue.component('column4', {  //проверка срока дедлайна: срок не выполнен - просроченная,
    ...
    <div class="column">
        <h3>Выполненные задачи</h3>
         <div class="card" v-bind:style="{backgroundColor:card.coloR}"  v-for="card in column4">
            <ul>
                 <li class="title"><b>Заголовок:</b> {{ card.title }}</li>
                <li><b>Описание задачи:</b> {{ card.description }}</li>
                <li><b>Дата создания:</b> {{ card.dateC }}</li>
